...
if(Resources.find().count() !== 0) {
  ...
  "shortDescription": "Operation Neptune is an educational computer game produced in 1991 by The Learning Company. The goal of the game is to guide a small submarine through a variety of undersea caverns, collecting pieces of a ruined space capsule. Like other games by The Learning Company, Operation Neptune is educational and was intended for players age nine to fourteen (grades five through nine).[2] It was released as part of the Super Solvers series for a time. (wikipedia)",
  ...
  "subject": [
      { "id": "0001", "subject": "math" },
      { "id": "0002", "subject": "history" },
      { "id": "0003", "subject": "science" },
      { "id": "0004", "subject": "health" },
    ],
  "ages": "test",
  ...
  {
  "name": "Oregon Trail",
  "shortDescription": "The Oregon Trail is a computer game originally developed by Don Rawitsch, Bill Heinemann, and Paul Dillenberger in 1971 and produced by the Minnesota Educational Computing Consortium (MECC) in 1974. The original game was designed to teach school children about the realities of 19th century pioneer life on the Oregon Trail. The player assumes the role of a wagon leader guiding his or her party of settlers from Independence, Missouri, to Oregon's Willamette Valley on the Oregon Trail via a covered wagon in 1848. (wikipedia)",
